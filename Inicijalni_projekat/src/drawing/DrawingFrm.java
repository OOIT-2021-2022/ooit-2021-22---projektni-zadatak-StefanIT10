...
public class DrawingFrm extends JFrame {
	...
	public DrawingFrm() {
		...
		gl_pnlNorthWest.setHorizontalGroup(gl_pnlNorthWest.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_pnlNorthWest.createSequentialGroup().addGap(32)
						.addGroup(gl_pnlNorthWest.createParallelGroup(Alignment.TRAILING)
								.addComponent(tglbtnSelect, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 71,
										Short.MAX_VALUE)
								.addComponent(tglbtnDrawing, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addGap(35)));
		gl_pnlNorthWest.setVerticalGroup(gl_pnlNorthWest.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlNorthWest.createSequentialGroup().addContainerGap().addComponent(tglbtnDrawing)
						.addGap(18).addComponent(tglbtnSelect).addContainerGap(31, Short.MAX_VALUE)));
		...
		gl_pnlTool.setHorizontalGroup(gl_pnlTool.createParallelGroup(Alignment.LEADING)
		...
		gl_pnlTool.setVerticalGroup(gl_pnlTool.createParallelGroup(Alignment.LEADING)
		...
		gl_pnlNorthEast.setHorizontalGroup(gl_pnlNorthEast.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_pnlNorthEast.createSequentialGroup().addGap(72)
						.addComponent(tglbtnPoint, GroupLayout.PREFERRED_SIZE, 82, GroupLayout.PREFERRED_SIZE)
						.addGap(59).addComponent(tglbtnLine, GroupLayout.PREFERRED_SIZE, 88, GroupLayout.PREFERRED_SIZE)
						.addGap(67)
						...
						.addGap(99)));
		gl_pnlNorthEast.setVerticalGroup(gl_pnlNorthEast.createParallelGroup(Alignment.LEADING).addGroup(gl_pnlNorthEast
		...
		gl_pnlNorthTop.setHorizontalGroup(gl_pnlNorthTop.createParallelGroup(Alignment.TRAILING).addGroup(gl_pnlNorthTop
				...
				.addGroup(gl_pnlNorthTop.createParallelGroup(Alignment.TRAILING, false)
						.addComponent(btnDelete, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)
						.addComponent(btnModify, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE))
				.addGap(34)));
		gl_pnlNorthTop.setVerticalGroup(gl_pnlNorthTop.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlNorthTop.createSequentialGroup().addContainerGap().addComponent(btnModify).addGap(18)
	...
	private MouseAdapter pnlDrawingClickListener() {
		return new MouseAdapter() {
			// Upotrebicemo mouseReleased jer mouseClicked se nekada ne okida
			public void mouseReleased(MouseEvent e) {
				Point mouseClick = new Point(e.getX(), e.getY());
				
				if (!pnlDrawing.contains(new java.awt.Point(e.getX(), e.getY()))) {
					// Necemo da nam je mis van panela za crtanje
					return;
				}
